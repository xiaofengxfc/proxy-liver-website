...
const SERVICE_CATEGORIES = [
  ...
  },
  {
    name: '周期活动',
    items: [
      { id: 'evt_big', name: '大活动', icon: '', desc: '40~60r 视具体活动定价', variants: [{ label: '咨询', price: 0 }], noPriceTag: true },
      { id: 'evt_small', name: '小活动', icon: '', desc: '', variants: [{ label: '完成', price: 20 }] },
      { id: 'evt_tower', name: '深塔', icon: '', desc: '', variants: [{ label: '一期', price: 30 }] },
      { id: 'evt_sea', name: '海墟', icon: '', desc: '', variants: [{ label: '一期', price: 30 }] },
    ],
  },
  {
    name: '常驻活动',
    items: [
      { id: 'evt_perm_1', name: '失序梦图', icon: '', desc: '', variants: [{ label: '完成', price: 60 }] },
      { id: 'evt_perm_2', name: '老人与海', icon: '', desc: '', variants: [{ label: '完成', price: 80 }] },
      { id: 'evt_perm_3', name: '团团转', icon: '', desc: '', variants: [{ label: '完成', price: 40 }] },
      { id: 'evt_perm_4', name: '旌旗不落', icon: '', desc: '', variants: [{ label: '完成', price: 40 }] },
      { id: 'evt_perm_5', name: '激斗荣耀之丘', icon: '', desc: '', variants: [{ label: '完成', price: 100 }] },
      { id: 'evt_perm_6', name: '唯你的长夏永不凋落', icon: '', desc: '', variants: [{ label: '完成', price: 15 }] },
      { id: 'evt_perm_7', name: '浸梦海床', icon: '', desc: '', variants: [{ label: '完成', price: 180 }] },
      { id: 'evt_perm_8', name: '幻梦游园', icon: '', desc: '', variants: [{ label: '完成', price: 50 }] },
      { id: 'evt_perm_9', name: '潮蚀模拟', icon: '', desc: '', variants: [{ label: '完成', price: 100 }] },
      { id: 'evt_perm_10', name: '穗波', icon: '', desc: '', variants: [{ label: '完成', price: 50 }] },
      { id: 'evt_perm_11', name: '开辟测界之路', icon: '', desc: '', variants: [{ label: '完成', price: 40 }] },
      { id: 'evt_perm_12', name: '拉海洛先行计划', icon: '', desc: '', variants: [{ label: '完成', price: 40 }] },
      { id: 'evt_perm_13', name: '荣耀之丘：激斗重反', icon: '', desc: '', variants: [{ label: '完成', price: 80 }] },
      { id: 'evt_perm_14', name: '诸星密语', icon: '', desc: '', variants: [{ label: '完成', price: 10 }] },
      { id: 'evt_perm_15', name: '沿着节拍启航', icon: '', desc: '', variants: [{ label: '完成', price: 40 }] },
    ],
  },
  {
    name: '数据坞',
